...
VALUES
  ...
  ('customer_data.export.party.artifact.download', '1.0.0', 'crm.customer-data-operations', '0.1.0', 'crm.application.http.ExportArtifactDisclosure', 'DownloadPartyExportArtifact', decode(repeat('61', 32), 'hex'), decode(repeat('62', 32), 'hex'), 'high', false, true, false, false, false, false, true, ARRAY['personal']::text[]),
