...
-- Minimal durable registry fixture required only to create authoritative Party
-- records for the non-runtime owner privacy-scope PostgreSQL acceptance suite.
