...
-- Minimal durable registry fixture required to create authoritative Consent
-- records and Party-to-Consent relationships for the non-runtime owner scope suite.
...
VALUES (
  ...
  '{"module_id":"crm.consents","version":"0.2.0"}'::jsonb,
  clock_timestamp(),
  'customer-platform'
)
