...
path.write_text(r'''mod process {
    ...
    use crm_customer_enrichment::{
        ProviderAdapterCoordinate, ProviderProcessCanonicalOutcome, ProviderProcessOutcomeKind,
    ...
    async fn exact_host_http_transport_records_one_canonical_process_outcome() {
        ...
        assert_eq!(recorded_request.status(), EnrichmentRequestStatus::ResponseRecorded);
        ...
        assert_eq!(outcome.provider_response_receipt_id(), Some(receipt_id.as_str()));
