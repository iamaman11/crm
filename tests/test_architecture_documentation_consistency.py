...
class ArchitectureDocumentationConsistencyTests(unittest.TestCase):
    ...
    def test_active_step_20a_product_plane_packet_is_exact(self) -> None:
        ...
        self.assertEqual(self.packet["packet_id"], "repository-step-20a-customer-privacy-product-plane")
        ...
        self.assertEqual(set(self.packet["allowed_paths"]), {
