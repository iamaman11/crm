...
class RepositoryNavigationTests(unittest.TestCase):
    def test_active_packet_declaration_is_exact(self) -> None:
        ...
        self.assertEqual(
            packet["packet_id"], "repository-step-17-preproduction-retirement"
        )
    ...
    def test_packet_check_uses_exact_planning_baseline(self) -> None:
            ...
            "selected_workflows": [
                {
                    ...
                    "selected": True,
                    "reasons": ["Step 17 never-released retirement"],
                }
        ...
        with (
            patch(
                ...
                return_value="996d634a33945e618be5ff81c297f0f617ce19d5",
            ),
