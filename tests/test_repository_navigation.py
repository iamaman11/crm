...
class RepositoryNavigationTests(unittest.TestCase):
    def test_active_packet_declaration_is_exact(self) -> None:
        ...
        self.assertEqual(
            packet["packet_id"], "repository-step-17-accepted-evidence-sync"
        )
    ...
    def test_packet_check_uses_exact_planning_baseline(self) -> None:
            ...
            "selected_workflows": [
                {
                    ...
                    "selected": True,
                    "reasons": ["Step 17 accepted evidence synchronization"],
                }
        ...
        with (
            patch(
                ...
                return_value="ea3d3894d05e3a8d814aff69824b593843763d03",
            ),
