...
class RepositoryNavigationTests(unittest.TestCase):
    def test_active_step_19_packet_declaration_is_exact(self) -> None:
        ...
        self.assertEqual(packet["packet_id"], "repository-step-19-postgres-ready-work")
    ...
    def test_generated_navigation_is_deterministic_and_current(self) -> None:
        ...
        self.assertIn("repository-step-19-postgres-ready-work", first[ACTIVE_PACKET_PATH])
        self.assertIn(
    ...
    def test_packet_check_uses_exact_planning_baseline(self) -> None:
            ...
            "selected_workflows": [
                {
                    ...
                    "selected": True,
                    "reasons": ["Step 19 PostgreSQL ready-work source"],
                }
        ...
        with (
            patch(
                ...
                return_value="c0fec3ae08c836ab483737442ed4377c99c85e9a",
            ),
