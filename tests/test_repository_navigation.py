...
class RepositoryNavigationTests(unittest.TestCase):
    def test_active_packet_declaration_is_exact(self) -> None:
        ...
        self.assertEqual(packet["packet_id"], "repository-step-16-worker-contention")
    ...
    def test_generated_navigation_is_deterministic_and_current(self) -> None:
        ...
        self.assertIn("repository-step-16-worker-contention", first[ACTIVE_PACKET_PATH])
        self.assertIn(
            "6f82de0a7b2dcd1ab5dd0ae6473d46d7d9d34bdd", first[ACTIVE_PACKET_PATH]
        )
    ...
    def test_packet_check_uses_exact_planning_baseline(self) -> None:
        ...
        affected = {
            ...
            "affected_packages": ["crm-api"],
            "selected_workflows": [
                {
                    "name": name,
                    "path": workflow_paths[name],
                    "selected": True,
                    "reasons": ["Step 16 real worker contention"],
                }
        ...
        with (
            patch(
                ...
                return_value="6f82de0a7b2dcd1ab5dd0ae6473d46d7d9d34bdd",
            ),
