...
class RepositoryNavigationTests(unittest.TestCase):
    def test_active_step_19_packet_declaration_is_exact(self) -> None:
        ...
        self.assertEqual(packet["packet_id"], "repository-step-19-runtime-registration")
    ...
    def test_generated_navigation_is_deterministic_and_current(self) -> None:
        ...
        self.assertIn("repository-step-19-runtime-registration", first[ACTIVE_PACKET_PATH])
        self.assertIn(
    ...
    def test_packet_check_uses_exact_planning_baseline(self) -> None:
            ...
            "selected_workflows": [
                {
                    ...
                    "selected": True,
                    "reasons": ["Step 19 runtime registration"],
                }
        ...
        with (
            patch(
                ...
                return_value="bc653de5f1a853791d3ab4a03f59f3daad54bf54",
            ),
