...
class RepositoryNavigationTests(unittest.TestCase):
    def test_active_packet_declaration_is_exact(self) -> None:
        ...
        self.assertEqual(packet["packet_id"], "repository-step-16-evidence-sync")
    ...
    def test_generated_navigation_is_deterministic_and_current(self) -> None:
        ...
        self.assertIn("repository-step-16-evidence-sync", first[ACTIVE_PACKET_PATH])
        self.assertIn(
            "ce0ca881461d1ee8964a11b28c1fcff46cf145cb", first[ACTIVE_PACKET_PATH]
        )
    ...
    def test_packet_check_uses_exact_planning_baseline(self) -> None:
            ...
            "selected_workflows": [
                {
                    ...
                    "selected": True,
                    "reasons": ["Step 16 evidence synchronization"],
                }
        ...
        with (
            patch(
                ...
                return_value="ce0ca881461d1ee8964a11b28c1fcff46cf145cb",
            ),
