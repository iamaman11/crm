...
impl crm_customer_enrichment_materialization_composition::ProviderSuggestionCandidateEvidenceSourcePort
    for ForbiddenEvidenceSource
{
    fn load<'a>(
        &'a self,
        _request: crm_customer_enrichment_materialization_composition::ProviderSuggestionCandidateEvidenceRequest,
    ) -> crm_module_sdk::PortFuture<'a, Result<wire::MaterializeSuggestionsRequest, SdkError>> {
        self.calls
...
impl crm_customer_enrichment_materialization_composition::SuggestionMaterializationExecutorPort
    for ForbiddenMaterializationExecutor
{
    fn execute<'a>(
        &'a self,
