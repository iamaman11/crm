...
pub(crate) fn configured<T>(value: Result<T, IdentifierError>) -> Result<T, SdkError> {
    value.map_err(|error| {
        SdkError::new(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_CONFIGURATION_INVALID",
            ErrorCategory::Internal,
            false,
            "The Identity Resolution privacy scope configuration is invalid.",
        )
...
pub(crate) fn map_request_contract_error(error: QueryRequestContractError) -> SdkError {
    match error {
        ...
        QueryRequestContractError::BindingMismatch => invalid_contract(
            ...
            "The Identity Resolution privacy scope request binding is invalid.",
        ),
        QueryRequestContractError::InputContractMismatch => invalid_contract(
            ...
            "The Identity Resolution privacy scope request contract is invalid.",
        ),
        QueryRequestContractError::InputHashMismatch => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_INPUT_HASH_MISMATCH",
            "The Identity Resolution privacy scope request integrity check failed.",
        ),
    }
}
...
pub(crate) fn map_common_lineage_error(error: CommonLineageError) -> SdkError {
    match error {
        CommonLineageError::TenantMismatch => invalid_contract(
            ...
            "The Identity Resolution privacy scope lineage is invalid.",
        ),
        CommonLineageError::CaseIdInvalid(reference) => invalid_contract_with_reference(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_CASE_ID_INVALID",
            "The Identity Resolution privacy scope lineage is invalid.",
            reference,
        ),
        CommonLineageError::PartyMissing => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_PARTY_INVALID",
            "The Identity Resolution privacy scope lineage is invalid.",
        ),
        ...
        CommonLineageError::GenerationInvalid => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_GENERATION_INVALID",
            "The Identity Resolution privacy scope lineage is invalid.",
        ),
        CommonLineageError::RegistryInvalid => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_REGISTRY_INVALID",
            "The Identity Resolution privacy scope registry identity is invalid.",
        ),
        CommonLineageError::RegistryUnavailable(reference) => SdkError::new(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_REGISTRY_UNAVAILABLE",
            ErrorCategory::Internal,
            false,
            "The Identity Resolution privacy scope registry is unavailable.",
        )
        .with_internal_reference(reference),
        CommonLineageError::RegistryMismatch => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_REGISTRY_MISMATCH",
            "The Identity Resolution privacy scope registry identity is invalid.",
        ),
        CommonLineageError::PurposeInvalid => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_PURPOSE_INVALID",
            "The Identity Resolution privacy scope purpose is invalid.",
        ),
        CommonLineageError::RequestTimeInvalid => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_REQUEST_TIME_INVALID",
            "The Identity Resolution privacy scope request time is invalid.",
        ),
        CommonLineageError::PageSizeInvalid => invalid_contract(
            "IDENTITY_RESOLUTION_PRIVACY_SCOPE_PAGE_SIZE_INVALID",
            "The Identity Resolution privacy scope page size is invalid.",
        ),
    }
}
...
pub(crate) fn lineage_invalid(
    ...
    SdkError::new(
        ...
        category,
        retryable,
        "The requested Identity Resolution privacy scope is not available.",
    )
    .with_internal_reference(reference.into())
}

pub(crate) fn stored_candidate_state_invalid(reference: impl Into<String>) -> SdkError {
    SdkError::new(
        "IDENTITY_RESOLUTION_PRIVACY_SCOPE_CANDIDATE_STATE_INVALID",
        ErrorCategory::Unavailable,
        true,
        "The Identity Resolution privacy scope is temporarily unavailable.",
    )
    .with_internal_reference(reference.into())
}

pub(crate) fn stored_merge_state_invalid(reference: impl Into<String>) -> SdkError {
    SdkError::new(
        "IDENTITY_RESOLUTION_PRIVACY_SCOPE_MERGE_STATE_INVALID",
        ErrorCategory::Unavailable,
        true,
        "The Identity Resolution privacy scope is temporarily unavailable.",
    )
...
pub(crate) fn topology_invalid(code: &'static str, reference: impl Into<String>) -> SdkError {
    SdkError::new(
        code,
        ErrorCategory::Unavailable,
        true,
        "The Identity Resolution privacy topology is temporarily unavailable.",
    )
    .with_internal_reference(reference.into())
}

pub(crate) fn limit_exceeded(code: &'static str, reference: impl Into<String>) -> SdkError {
    SdkError::new(
        code,
        ErrorCategory::Unavailable,
        true,
        "The Identity Resolution privacy scope could not complete within its safety bounds.",
    )
    .with_internal_reference(reference.into())
}

pub(crate) fn row_decode_error(error: sqlx::Error) -> SdkError {
    stored_merge_state_invalid(error.to_string())
}

pub(crate) fn database_unavailable(error: sqlx::Error) -> SdkError {
    SdkError::new(
        "IDENTITY_RESOLUTION_PRIVACY_SCOPE_UNAVAILABLE",
        ErrorCategory::Unavailable,
        true,
        "The Identity Resolution privacy scope is temporarily unavailable.",
    )
