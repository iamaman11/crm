...
pub(crate) fn configured<T>(value: Result<T, IdentifierError>) -> Result<T, SdkError> {
    value.map_err(|error| {
        SdkError::new(
            "CONTACT_POINTS_PRIVACY_SCOPE_CONFIGURATION_INVALID",
            ErrorCategory::Internal,
            false,
            "The Contact Points privacy scope configuration is invalid.",
        )
...
pub(crate) fn map_request_contract_error(error: QueryRequestContractError) -> SdkError {
    match error {
        ...
        QueryRequestContractError::BindingMismatch => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_REQUEST_BINDING_MISMATCH",
            "The Contact Points privacy scope request binding is invalid.",
        ),
        QueryRequestContractError::InputContractMismatch => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_INPUT_CONTRACT_MISMATCH",
            "The Contact Points privacy scope request contract is invalid.",
        ),
        QueryRequestContractError::InputHashMismatch => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_INPUT_HASH_MISMATCH",
            "The Contact Points privacy scope request integrity check failed.",
        ),
    }
}
...
pub(crate) fn map_common_lineage_error(error: CommonLineageError) -> SdkError {
    match error {
        CommonLineageError::TenantMismatch => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_TENANT_MISMATCH",
        ...
        CommonLineageError::CaseIdInvalid(reference) => invalid_contract_with_reference(
            "CONTACT_POINTS_PRIVACY_SCOPE_CASE_ID_INVALID",
            "The Contact Points privacy scope lineage is invalid.",
            reference,
        ),
        CommonLineageError::PartyMissing => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_PARTY_INVALID",
            "The Contact Points privacy scope lineage is invalid.",
        ),
        ...
        CommonLineageError::GenerationInvalid => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_GENERATION_INVALID",
            "The Contact Points privacy scope lineage is invalid.",
        ),
        CommonLineageError::RegistryInvalid => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_REGISTRY_INVALID",
            "The Contact Points privacy scope registry identity is invalid.",
        ),
        CommonLineageError::RegistryUnavailable(reference) => SdkError::new(
            "CONTACT_POINTS_PRIVACY_SCOPE_REGISTRY_UNAVAILABLE",
            ErrorCategory::Internal,
            false,
            "The Contact Points privacy scope registry is unavailable.",
        )
        .with_internal_reference(reference),
        CommonLineageError::RegistryMismatch => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_REGISTRY_MISMATCH",
            "The Contact Points privacy scope registry identity is invalid.",
        ),
        CommonLineageError::PurposeInvalid => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_PURPOSE_INVALID",
            "The Contact Points privacy scope purpose is invalid.",
        ),
        CommonLineageError::RequestTimeInvalid => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_REQUEST_TIME_INVALID",
            "The Contact Points privacy scope request time is invalid.",
        ),
        CommonLineageError::PageSizeInvalid => invalid_contract(
            "CONTACT_POINTS_PRIVACY_SCOPE_PAGE_SIZE_INVALID",
            "The Contact Points privacy scope page size is invalid.",
        ),
    }
}
...
pub(crate) fn lineage_invalid(
    ...
    SdkError::new(
        ...
        category,
        retryable,
        "The requested Contact Points privacy scope is not available.",
    )
...
pub(crate) fn stored_state_invalid(reference: impl Into<String>) -> SdkError {
    SdkError::new(
        ...
        true,
        "The Contact Points privacy scope is temporarily unavailable.",
    )
    .with_internal_reference(reference.into())
}
...
pub(crate) fn database_unavailable(error: sqlx::Error) -> SdkError {
    SdkError::new(
        "CONTACT_POINTS_PRIVACY_SCOPE_UNAVAILABLE",
        ErrorCategory::Unavailable,
        true,
        "The Contact Points privacy scope is temporarily unavailable.",
    )
