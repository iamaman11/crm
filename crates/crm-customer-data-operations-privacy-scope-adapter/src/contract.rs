...
pub const INPUT_RETENTION_POLICY_ID: &str =
    "crm.customer-data-operations.privacy.scope.request";
pub const OUTPUT_RETENTION_POLICY_ID: &str =
    "crm.customer-data-operations.privacy.scope.response";
