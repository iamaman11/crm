...
pub const CAPABILITY_ID: &str = "customer_data.privacy.scope.contribute";
pub const CAPABILITY_VERSION: &str = "1.0.0";
pub const INPUT_SCHEMA_ID: &str =
    "crm.customer_privacy.v1.CustomerDataPrivacyScopeContributionRequest";
pub const OUTPUT_SCHEMA_ID: &str =
    "crm.customer_privacy.v1.CustomerDataPrivacyScopeContributionResponse";
...
pub const INPUT_RETENTION_POLICY_ID: &str = "crm.customer-data-operations.privacy.scope.request";
pub const OUTPUT_RETENTION_POLICY_ID: &str = "crm.customer-data-operations.privacy.scope.response";
pub const DEFAULT_PAGE_SIZE: u32 = 64;
pub const MAXIMUM_PAGE_SIZE: u32 = 128;
pub const MAXIMUM_CURSOR_BYTES: usize = 2_048;

pub const MAX_PRIVACY_IMPORT_ROWS_SCANNED: usize = 16_384;
pub const MAX_PRIVACY_EXPORT_SELECTION_ITEMS_SCANNED: usize = 16_384;
pub const MAX_PRIVACY_ASSOCIATED_EXPORT_RECORDS_REHYDRATED: usize = 32_768;
pub const MAX_PRIVACY_CANONICAL_PARTY_RESOLUTIONS: usize = 32_768;
pub const MAX_PRIVACY_OWNER_RECORDS_SCANNED: usize = 65_536;

pub fn customer_data_privacy_scope_definition() -> Result<CapabilityDefinition, SdkError> {
...
pub(crate) fn validate_definition(definition: &CapabilityDefinition) -> Result<(), SdkError> {
    if definition != &customer_data_privacy_scope_definition()? {
        return Err(crate::errors::invalid_contract(
            "CUSTOMER_DATA_PRIVACY_SCOPE_DEFINITION_MISMATCH",
            "The Customer Data Operations privacy scope definition is invalid.",
        ));
    }
    Ok(())
}
