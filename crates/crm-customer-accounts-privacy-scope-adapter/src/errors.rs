...
pub(crate) fn configured<T>(value: Result<T, IdentifierError>) -> Result<T, SdkError> {
    value.map_err(|error| {
        SdkError::new(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_CONFIGURATION_INVALID",
            ErrorCategory::Internal,
            false,
            "The Customer Accounts privacy scope configuration is invalid.",
        )
...
pub(crate) fn map_common_lineage_error(error: CommonLineageError) -> SdkError {
    match error {
        CommonLineageError::TenantMismatch => invalid_contract(
            ...
            "The Customer Accounts privacy scope lineage is invalid.",
        ),
        CommonLineageError::CaseIdInvalid(reference) => invalid_contract_with_reference(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_CASE_ID_INVALID",
            "The Customer Accounts privacy scope lineage is invalid.",
            reference,
        ),
        CommonLineageError::PartyMissing => invalid_contract(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_PARTY_INVALID",
            "The Customer Accounts privacy scope lineage is invalid.",
        ),
        ...
        CommonLineageError::GenerationInvalid => invalid_contract(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_GENERATION_INVALID",
            "The Customer Accounts privacy scope lineage is invalid.",
        ),
        CommonLineageError::RegistryInvalid => invalid_contract(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_REGISTRY_INVALID",
            "The Customer Accounts privacy scope registry identity is invalid.",
        ),
        CommonLineageError::RegistryUnavailable(reference) => SdkError::new(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_REGISTRY_UNAVAILABLE",
            ErrorCategory::Internal,
            false,
            "The Customer Accounts privacy scope registry is unavailable.",
        )
        .with_internal_reference(reference),
        CommonLineageError::RegistryMismatch => invalid_contract(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_REGISTRY_MISMATCH",
            "The Customer Accounts privacy scope registry identity is invalid.",
        ),
        CommonLineageError::PurposeInvalid => invalid_contract(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_PURPOSE_INVALID",
            "The Customer Accounts privacy scope purpose is invalid.",
        ),
        CommonLineageError::RequestTimeInvalid => invalid_contract(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_REQUEST_TIME_INVALID",
            "The Customer Accounts privacy scope request time is invalid.",
        ),
        CommonLineageError::PageSizeInvalid => invalid_contract(
            "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_PAGE_SIZE_INVALID",
            "The Customer Accounts privacy scope page size is invalid.",
        ),
    }
}
...
pub(crate) fn lineage_invalid(
    ...
    SdkError::new(
        ...
        category,
        retryable,
        "The requested Customer Accounts privacy scope is not available.",
    )
...
pub(crate) fn stored_state_invalid(reference: impl Into<String>) -> SdkError {
    SdkError::new(
        ...
        true,
        "The Customer Accounts privacy scope is temporarily unavailable.",
    )
    .with_internal_reference(reference.into())
}
...
pub(crate) fn database_unavailable(error: sqlx::Error) -> SdkError {
    SdkError::new(
        "CUSTOMER_ACCOUNTS_PRIVACY_SCOPE_UNAVAILABLE",
        ErrorCategory::Unavailable,
        true,
        "The Customer Accounts privacy scope is temporarily unavailable.",
    )
