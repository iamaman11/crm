...
pub struct CustomerEnrichmentCapabilityPlanner;

impl TransactionalAggregatePlanner for CustomerEnrichmentCapabilityPlanner {
    fn target(
        &self,
        ...
        match definition.capability_id.as_str() {
            PUBLISH_PROVIDER_PROFILE_CAPABILITY => {
                CustomerEnrichmentProviderProfileCapabilityPlanner.target(definition, request)
            }
            PUBLISH_MAPPING_CAPABILITY => {
