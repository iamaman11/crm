use crate::contract::{
    CAPABILITY_ID, CAPABILITY_VERSION, DEFAULT_PAGE_SIZE, MAX_PRIVACY_ACTIVE_REDIRECT_EDGES,
    MAX_PRIVACY_ALIAS_HOPS, MAX_PRIVACY_ALIAS_NODES, MAX_PRIVACY_APPLICATION_ATTEMPTS_SCANNED,
    MAX_PRIVACY_ASSOCIATION_RECORDS_REHYDRATED, MAX_PRIVACY_CANONICAL_PARTY_RESOLUTIONS,
    MAX_PRIVACY_DEFINITION_RECORDS_REHYDRATED, MAX_PRIVACY_OWNER_RECORDS_SCANNED,
    MAX_PRIVACY_PROVIDER_USAGE_ENTRIES_SCANNED, MAX_PRIVACY_REQUEST_RECORDS_REHYDRATED,
    MAX_PRIVACY_REQUEST_RELATIONSHIPS_SCANNED, MAX_PRIVACY_RESPONSE_CONFLICTS_SCANNED,
    MAX_PRIVACY_RESPONSE_RECEIPTS_SCANNED, MAX_PRIVACY_REVIEW_DECISIONS_SCANNED,
    MAX_PRIVACY_SUGGESTIONS_SCANNED, MAXIMUM_CURSOR_BYTES, MAXIMUM_PAGE_SIZE,
