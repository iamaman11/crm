//! Owner production composition for Customer Accounts mutation and query contributions.

use crate::{AccountQueryAdapter, query_capability_definitions};
...
#[derive(Clone)]
struct AccountPartyReferenceSemanticValidator {
...
impl AccountPartyReferenceSemanticValidator {
    fn new(parties: Arc<dyn PartyReferenceReader>) -> Self {
        Self { parties }
    }
}
...
/// the authoritative owner adapter rather than the generic process host.
