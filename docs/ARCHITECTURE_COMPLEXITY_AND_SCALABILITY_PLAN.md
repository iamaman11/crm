...
| B — dependency, crate and exception governance | **In progress** | reproducible baseline, crate justification, calibrated inheritance cohorts, root-family no-growth, exact Rust `1.97.1` toolchain/workspace `rust-version`, measured zero-warning Rust/Clippy baseline, lockfile-preserving Rust workflows, blocking suppression governance and zero direct lint tables accepted through PR #255 | remaining ADR-031 central process-host dependency and representative change-cost/dependency-version-feature exit evidence at step 13, measured consolidation at step 14, and remeasurement at steps 22 and 25 |
...
| B — dependency, crate and exception governance | steps 13, 14, 22 and 25, plus every structural preflight | PR #255 accepts blocking calibrated governance and zero direct lint tables; step 13 still requires central process-host dependency reduction or justified non-growth plus representative change-cost/dependency-version-feature exit proof; no unjustified package growth; expired exceptions zero; measured before/after reports |
...
The inserted repository step 4 prerequisite is complete through PR #224, repository step 4 is complete through PR #226, repository step 5 is complete through PR #228, the inserted lockfile-preservation prerequisite before repository step 6 is complete through PR #232, repository step 6 is complete through PR #230, repository step 7 is complete through PR #235, repository step 8 is complete through PR #237, repository step 9 is complete through PR #239, repository step 10 is complete through PR #241, repository step 11 is complete through PR #244, repository step 12 is complete through PR #249, and repository step 13 has accepted measurement through PR #253 plus blocking suppression/direct-lint governance through PR #255. None changes the master numbering; repository step 13 remains unfinished.
...
Repository step 12 was delivered as sequential bounded behavior-neutral owner batches and is complete through PR #249. Repository step 13 is a separate behavior-neutral governance step: PR #253 accepted measurement and PR #255 accepted blocking suppression/direct-lint governance, while the remaining ADR-031 central process-host dependency and representative change-cost/dependency-version-feature exit evidence must still close before step 14. Repository step 17 separately enforces the published contract lifecycle. Repository step 22 publishes measurements and remaining blockers; it cannot waive the two later-wave requirement or close issue #194.
...
Repository steps 1–12 are complete. Repository step 13 is in progress under ADR-031: PR #253 accepted the exact 113-package measurement baseline and PR #255 accepted blocking suppression governance, zero direct lint tables and calibrated role-aware budgets without product behavior changes. The next permitted packet is remaining exit-gap remeasurement and only evidence-required bounded remediation. Repository step 14 remains blocked.
...
- PR #253 supplied measurement/calibration and PR #255 activated blocking suppression/direct-lint governance; remaining step-13 remediation is permitted only when current evidence proves an exit gap.

Representative baselines are collected. PR #255 activates blocking suppression and calibrated role-aware governance; any remaining warning-to-blocking transition must be justified by the relevant ADR-031 exit evidence.
...
At the historical PR #251 boundary that first packet was not yet started and was forbidden from centralizing dependency features, consolidating crates, removing exceptions, changing runtime composition or modifying product behavior. PR #253 later accepted the measurement packet, and PR #255 accepted the first blocking behavior-neutral remediation. Repository step 13 remains in progress; repository step 14 remains blocked.
...
Repository step 13 is **in progress**. Its ADR-031 measurement packet is accepted through PR #253 and blocking suppression/direct-lint governance through PR #255; only the remaining exit-gap remeasurement and evidence-driven remediation may proceed. No later repository step may start before step 13 is complete. Customer Privacy and Phase 8A product readiness remain unchanged; current product-complete expert modules remain **0**.
