...
| B — dependency, crate and exception governance | step 13 plus every structural preflight; remeasurement at steps 22 and 25 | PRs #253, #255 and #257 accept all ADR-031 exit evidence: no unjustified package growth, expired exceptions zero, central process-host dependency non-growth and representative change-cost/dependency-version-feature budgets are blocking |
