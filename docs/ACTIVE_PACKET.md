...
<!-- schema: crm.repository-navigation/v1; source-digest: sha256:d6c109b9aa7895860ee101a7018f58c1eca5e6448436c65e67bdca771bc309db -->

# Active Repository Packet

- **Packet:** `repository-step-17-contract-usage-telemetry` — Instrument deprecated capability usage in production
- **Status:** `active`
- **Tracking:** #126, #194
- **Baseline:** `main` / `a9d6a3c58dc0418343a8919ae731aa5c8b3f92e8`
- **Source digest:** `sha256:d6c109b9aa7895860ee101a7018f58c1eca5e6448436c65e67bdca771bc309db`

## Objective

Continue Repository Step 17 with deterministic, production-shaped usage telemetry for deprecated exact-version capability contracts. Generate a typed runtime catalog from the governed lifecycle policy, wrap the existing mutation and query registries without changing generic gateway APIs, count every successfully resolved deprecated coordinate before later semantic or authorization decisions, preseed zero series for retirement evidence and expose low-cardinality Prometheus text without tenant, actor, request or payload data. Keep process-host LOC and workspace public surface at or below their accepted ceilings by placing reusable registry decoration in the existing capability-adapters package.
...
- the branch is based exactly on main commit a9d6a3c58dc0418343a8919ae731aa5c8b3f92e8 and contains only the fourteen declared telemetry packet files
