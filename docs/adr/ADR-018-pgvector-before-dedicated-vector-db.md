# ADR-018: pgvector before dedicated vector DB
...
Use PostgreSQL pgvector for initial semantic retrieval; adopt a separate vector database only after benchmark or required functionality.
