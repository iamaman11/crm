...
Current production route inventory: **4 mutations + 3 permission-aware queries**; the remaining 10 published coordinates stay individually non-runtime. This inventory is authoritative only on a canonical Generated Sync state and a green exact-head workflow matrix.
